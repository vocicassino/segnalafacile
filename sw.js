const CACHE_NAME = "segnalafacile-map-v12-live-v1";
...
async function injectEnhancements(response,kind){
  ...
  if(kind==="main"&&!html.includes("map-enhancements.css"))html=html.replace("</head>",'  <link rel="stylesheet" href="./map-enhancements.css?v=6" />\n</head>');
  if(kind==="main"&&!html.includes("map-enhancements.js"))html=html.replace("</body>",'  <script src="./map-enhancements.js?v=6"></script>\n</body>');
  ...
  if(kind==="main"&&!html.includes("live-enhancements.css"))html=html.replace("</head>",'  <link rel="stylesheet" href="./live-enhancements.css?v=1" />\n</head>');
  if(kind==="main"&&!html.includes("live-enhancements.js"))html=html.replace("</body>",'  <script src="./live-enhancements.js?v=1"></script>\n</body>');
