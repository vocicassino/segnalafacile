const CACHE_NAME = "segnalafacile-map-v18-live-v7";
...
async function injectEnhancements(response,kind){
  ...
  if(kind==="main"){
    html=html.replace(/map-enhancements\.css\?v=\d+/g,"map-enhancements.css?v=18");
    html=html.replace(/map-enhancements\.js\?v=\d+/g,"map-enhancements.js?v=18");
  }
  if(kind==="main"&&!html.includes("map-enhancements.css"))html=html.replace("</head>",'  <link rel="stylesheet" href="./map-enhancements.css?v=18" />\n</head>');
  if(kind==="main"&&!html.includes("map-enhancements.js"))html=html.replace("</body>",'  <script src="./map-enhancements.js?v=18"></script>\n</body>');
  ...
  if(kind==="main"&&!html.includes("live-enhancements.css"))html=html.replace("</head>",'  <link rel="stylesheet" href="./live-enhancements.css?v=7" />\n</head>');
  if(kind==="main"&&!html.includes("live-enhancements.js"))html=html.replace("</body>",'  <script src="./live-enhancements.js?v=7"></script>\n</body>');
